                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :margin="14" :dots="false" :items="3" :nav="false" >
                                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == primary_photo ? 'active' : '' ">
